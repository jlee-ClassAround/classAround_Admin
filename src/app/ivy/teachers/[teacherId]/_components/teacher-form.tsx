...
import { teacherSchema, TeacherSchema } from '@/lib/ivy/schemas';
import { cn } from '@/lib/utils';
import { Teacher } from '@/generated/ivy';
...
export function TeacherForm({ initialData, categories }: Props) {
    ...
    const onSubmit = async (values: TeacherSchema) => {
        try {
            await updateTeacherAction(initialData.id, values);
            toast.success(SUCCESS_MESSAGE);
            router.refresh();
            router.push('/ivy/teachers/all');
        } catch {
