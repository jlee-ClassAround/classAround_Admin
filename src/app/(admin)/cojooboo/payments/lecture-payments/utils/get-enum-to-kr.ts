...
export function getCashReceiptStatusToKr(cashReceiptStatus: CashReceiptStatus | null) {
...
export function getTaxInvoiceStatusToKr(taxInvoiceStatus: TaxInvoiceStatus | null) {
