...
import { faqSchema, FaqSchema } from '@/lib/cojooboo/schemas';
import { cn } from '@/lib/utils';
import { zodResolver } from '@hookform/resolvers/zod';
import { Category, Faq } from '@/generated/cojooboo';
import axios from 'axios';
import { Loader2 } from 'lucide-react';
import { useRouter } from 'next/navigation';
import { useForm } from 'react-hook-form';
import { toast } from 'sonner';
import { createFaqAction, updateFaqAction } from '../../all/actions';
    ...
    const onSubmit = async (values: FaqSchema) => {
        try {
            const res = initialData
                ? await updateFaqAction(initialData.id, values)
