...
export async function getNextLessonId({ lessonId }: Props) {
    try {
        ...
        const nextLesson = await cojoobooDb.lesson.findFirst({
            where: {
        ...
        const chapter = await cojoobooDb.chapter.findUnique({
            where: {
                id: lesson.chapterId,
                isPublished: true,
            },
        ...
        const nextChapter = await cojoobooDb.chapter.findFirst({
            where: {
