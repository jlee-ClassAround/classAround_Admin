...
import { PaymentStatus, ProductCategory, Prisma } from '@/generated/cojooboo';
...
/**
 * ✅ 타입 에러 해결 및 연도별 강의 목록 필터링을 수행합니다.
 */
export async function getCoursesWithCustomer(year?: number) {
    try {
        ...
        // ✅ [에러 해결] image_112b0c.png의 에러를 방지하기 위해 타입을 명시합니다.
