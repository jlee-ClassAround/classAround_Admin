...
import { Category, DetailImage, Ebook, ProductBadge } from '@/generated/cojooboo';
import { CircleX, FilePlus, FileText, ImagePlus, ImageUp, Loader2 } from 'lucide-react';
...
export function EbookForm({ ebook, categories, productBadges }: Props) {
    ...
    const onSubmit = async (values: EbookSchema) => {
        try {
            ...
            router.push('/cojooboo/ebooks/all');
            router.refresh();
        } catch {
