...
export function UserRoleManager({ userId, roleId, availableRoles }: UserRoleManagerProps) {
    ...
    const shouldDisableControls = roleId === 'super-admin' && selectedRole === 'super-admin';
